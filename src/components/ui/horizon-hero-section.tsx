...
export const Component = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      refs.stars.forEach((starField) => {
        if (
          starField.material instanceof THREE.ShaderMaterial &&
          starField.material.uniforms
        ) {
      ...
      refs.mountains.forEach((mountain, i) => {
        ...
        mountain.position.y =
          50 + Math.cos(time * 0.15) * 1 * parallaxFactor;
      });
    ...
    return () => {
      ...
      refs.stars.forEach((starField) => {
        ...
        (
          starField.material as THREE.ShaderMaterial
        ).dispose();
      });
      ...
      refs.mountains.forEach((mountain) => {
        ...
        (
          mountain.material as THREE.MeshBasicMaterial
        ).dispose();
      });
      ...
      if (refs.nebula) {
        ...
        (
          refs.nebula.material as THREE.ShaderMaterial
        ).dispose();
      }
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const nextPos =
        cameraPositions[newSection + 1] || currentPos;
      ...
      refs.mountains.forEach((mountain, i) => {
        const speed = 1 + i * 0.9;
        const targetZ =
          mountain.userData.baseZ + scrollY * speed * 0.5;
        if (refs.nebula) {
        ...
        {[...Array(2)].map((_, i) => {
          ...
          return (
            <section key={i} className="content-section">
              <h1 className="hero-title">{titles[i + 1]}</h1>
